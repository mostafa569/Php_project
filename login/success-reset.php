        ...
        <section class='form-col d-flex justify-content-center align-items-center flex-column'>
            <form class='mb-4 w-75'>
                ...
                <div class='mb-4'>
                    ...
                    <input type='password' name='password1' class='form-control' id='exampleInputPassword1' aria-describedby='passwordHelp' disabled>
                </div>
                <div class=''>
                    <label for='exampleInputPassword2' class='form-label'>Re-enter Password</label>
                    <input type='password' name='password2' class='form-control' id='exampleInputPassword2' aria-describedby='rePasswordHelp' disabled>
                </div>
            ...
            <div style='height:100px;'>
                <p class='alert alert-success p-2 text-center'>Password Updated Successfully :)</p>
            </div>
        </section>
    </section>';
